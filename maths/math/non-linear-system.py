from math import tan, fabs, cos, sin
...
def newton(system, eps=0.01):
    ...
    iters = 0
    t = 0
    while is_continue(x1, old_x1, x2, old_x2, eps) and t != 2:
        t += 1
        old_x1 = x1
        old_x2 = x2
        # delta_x1 = (-system[1](old_x1) + system[0](old_x2)) / ((-1/(cos(old_x1)**2)) - 6*old_x2 - 1)
        # delta_x2 = -system[0](old_x1, old_x2) - (6*old_x2 - 1) * delta_x1
        delta_x1 = (-system[1](old_x1) + system[0](old_x2))
        delta_x2 = 
        x1 = old_x1 + delta_x1
        x2 = old_x2 + delta_x2
        # print(x1, x2)
